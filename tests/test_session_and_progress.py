...
def test_player_progress_roundtrip():
    ...
    player = Player(team=[Pokemon("Pikachu", "Elétrico", level=3, hp=90, max_hp=120, xp=25)], items={"Poção": 2}, x=100, y=200, zone_index=1)
...
def test_json_player_progress_repository_roundtrip(tmp_path: Path):
    ...
    player = Player(team=[Pokemon("Bulbasaur", "Grama", level=4, hp=70, max_hp=120)], items={"Poção": 1}, x=15, y=25, zone_index=2)
